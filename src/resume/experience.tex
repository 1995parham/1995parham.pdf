...
\cventry{Jan 2017--Jan 2019}{Software Architect}{IoT Working Group of Amirkabir University of Technology}{Tehran, Iran}{}{
	\begin{itemize}
		\item Introduced and extended the open-source \textbf{IoT platform Mainflux} to build a scalable and secure backend infrastructure for end-to-end environmental monitoring.
		\item Designed a comprehensive IoT platform managing devices with multiple network protocols, including a \textbf{reliable transport layer over NRF} for home automation systems.
		\item Developed \textbf{microservices} in \textbf{Python} and \textbf{Golang} and implemented an \textbf{Angular}-based admin panel with \httpslink[\textbf{leaflet}]{leafletjs.com} for sensor visualization.
	\end{itemize}
}
\end{samepage}
...
\cventry{Jun 2014--May 2016}{Software Engineer}{Avidnet}{Tehran, Iran}{}{
	\begin{itemize}
		...
		\item Deployed services using \textbf{Docker Swarm} over staging and production environment, managing HPE ProLiant DL380 Gen9 servers with \textbf{VMware ESXi}.
	\end{itemize}
}
\end{samepage}
