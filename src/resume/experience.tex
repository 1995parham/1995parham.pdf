...
\cventry{Jan 2017--Jan 2019}{Software Architect}{IoT Working Group of Amirkabir University of Technology}{Tehran, Iran}{}{
	\begin{itemize}
		\item Introduced and extended the open-source \textbf{IoT platform Mainflux} to build a scalable and secure backend
		...
		\item Designed a \textbf{reliable transport layer} over \textbf{NRF} to create cheap home automation systems.
...
\cventry{Jul 2013--Mar 2017}{Software Engineer}{Nahalco}{Tehran, Iran}{}{
	\begin{itemize}
		\item Set up company website on \textbf{JAM Stack} using GitHub pages and Jekyll.
		\item Wrote different types of \textbf{scrappers} to scrape live cryptocurrency information from websites in Python.
		\item Developed a \textbf{GraphQL} API for the IoT Platform, enabling users to filter crop data with different filters.
		\item Used \textbf{serverless-like} architecture to run scrappers periodically on \textbf{Docker swarm} infrastructure.
		\item Provided a data-processing pipeline using \textbf{Apache Spark} to ingest the stock information.
	\end{itemize}
}
\end{samepage}
...
\cventry{Jan 2016--Jan 2017}{Software Engineer}{Computer \& Information Center of Amirkabir University of Technology}{Tehran, Iran}{}{
	\begin{itemize}
		\item Led the development of a \httpslink[\textbf{metering internet system}]{github.com/aut-cic/internet} using \httpslink[FreeRADIUS]{freeradius.org/} and Python,
		      enabling API calls to the FreeRADIUS system to display usage volumes.
	\end{itemize}
}
\end{samepage}
...
\cventry{Jun 2014--May 2016}{Software Engineer}{Avidnet}{Tehran, Iran}{}{
	\begin{itemize}
		...
		\item Proceeded with the installation and configuration of two HPE ProLiant DL380 Gen9 servers,
		      ensuring \textbf{VMware ESXi} is properly set up on both.
		\item Deployed services using \textbf{Docker Swarm} over staging and production environment.
	\end{itemize}
}
\end{samepage}
